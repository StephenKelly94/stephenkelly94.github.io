...
const config: SiteConfig = {
  ...
  site: 'https://stephenkelly94.github.io',
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/stephenkelly94',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/stephenkelly94',
    email: 'talk-to-stephen@pm.me',
    linkedin: 'https://www.linkedin.com/in/stephenkelly94/',
